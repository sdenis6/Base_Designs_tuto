...
In this section we show an example of use of the Data2Ram block, used to monitor data. 
\begin{center}
\begin{tikzpicture}
...
%\node[draw, rectangle, minimum size=.6cm, left of=dat, left of=dat, yshift=+.4cm] (plus1) {{\color{OliveGreen}$+$}};
%\node[above of=plus1, yshift=-.2cm] (c1) {\textbf{{\color{OliveGreen}Offset\_1}}};
%\node[draw, rectangle, minimum size=.6cm, left of=dat, left of=dat, yshift=-.4cm] (plus2) {{\color{OliveGreen}$+$}};
%\node[below of=plus2, yshift=+.2cm] (c2) {\textbf{{\color{OliveGreen}Offset\_2}}};
